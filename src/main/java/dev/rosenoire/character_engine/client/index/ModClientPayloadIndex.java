...
import dev.rosenoire.character_engine.client.payloads.SetVelocityFromServerS2CReceiver;
...
public interface ModClientPayloadIndex {
    static void registerAll() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(SetVelocityFromServerS2C.ID, SetVelocityFromServerS2CReceiver::handle);
    }
}
